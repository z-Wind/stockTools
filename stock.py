...
if __name__ == "__main__":
    ...
    symbols = [
        ...
        {"name": "VTI", "remark": "Vanguard 美股", "groups": ["美股", "Vanguard", "常用"]},
        ...
        {"name": "VPL", "remark": "Vanguard 太平洋股", "groups": ["太平洋股", "Vanguard", "常用"]},
        {
            "name": "VPADX",
        ...
        {"name": "VGK", "remark": "Vanguard 歐股", "groups": ["歐股", "Vanguard", "常用"]},
        ...
        {"name": "TIP", "remark": "iShares 美抗通膨公債", "groups": ["美債", "常用"]},
        ...
        {"name": "VTIP", "remark": "Vanguard 美抗通膨公債", "groups": ["美債", "Vanguard", "常用"]},
        {
            "name": "VTAPX",
            "remark": "Vanguard 美抗通膨公債 指數基金",
            "groups": ["美債", "Vanguard"],
        ...
        {"name": "AGG", "remark": "iShares 美債", "groups": ["美債", "常用"]},
        {"name": "SWAGX", "remark": "Schwab 美債 指數基金", "groups": ["美債"]},
        {"name": "SPAB", "remark": "SPDR 美債", "groups": ["美債"]},
        {"name": "BND", "remark": "Vanguard 美債", "groups": ["美債", "Vanguard", "常用"]},
        {"name": "VBTLX", "remark": "Vanguard 美債 指數基金", "groups": ["美債", "Vanguard"]},
        {"name": "IAGG", "remark": "iShares 國際債美元避險排美", "groups": ["國際債排美", "常用"]},
        {
            "name": "BNDX",
            "remark": "Vanguard 國際債美元避險排美",
            "groups": ["國際債排美", "Vanguard", "常用"],
        },
        {"name": "BWX", "remark": "SPDR 國際政府債排美", "groups": ["國際債排美", "常用"]},
    ]
    report(symbols, prefix="US", iYear=5, name_width=6)
    ...
    report(symbols, prefix="US_美國(美股,美債,美房地產)", iYear=2, name_width=6)
    ...
    report(symbols, prefix="US_日正", iYear=5, name_width=6)
